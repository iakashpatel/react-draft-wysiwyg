      ...
      >
        {options.indexOf("left") >= 0 && (
          <Option
            ...
            onClick={onChange}
            title={
              left.title || translations["components.controls.textalign.left"]
            }
          >
        ...
        {options.indexOf("center") >= 0 && (
          <Option
            ...
            title={
              center.title ||
              translations["components.controls.textalign.center"]
            }
          >
        ...
        {options.indexOf("right") >= 0 && (
          <Option
            ...
            onClick={onChange}
            title={
              right.title || translations["components.controls.textalign.right"]
            }
          >
        ...
        {options.indexOf("justify") >= 0 && (
          <Option
            ...
            title={
              justify.title ||
              translations["components.controls.textalign.justify"]
            }
          >
      ...
      >
        <span
          className={classNames(
            ...
            (config[textAlignment] && config[textAlignment].className) ||
              left.className
          )}
        >
          <img
